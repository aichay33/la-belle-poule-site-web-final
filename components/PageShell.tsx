...
const promises = [
  { label: "Projet à taille humaine", icon: <LeafIcon className="h-5 w-5" /> },
  { label: "Achat de terrain uniquement", icon: <LocationIcon className="h-5 w-5" /> },
  { label: "Vente directe", icon: <PeopleIcon className="h-5 w-5" /> },
];
        ...
        <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2.25rem] border border-green-deep/10 bg-white px-6 py-10 shadow-[0_30px_100px_rgba(31,36,24,0.08)] md:px-12 md:py-14">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <Link href="/contact" className="inline-flex items-center justify-center rounded-full border border-green-deep/15 px-7 py-3 text-sm font-bold uppercase tracking-[0.16em] text-green-deep transition hover:border-terracotta hover:text-terracotta">
                Contact direct
              </Link>
            </div>
          </div>
      ...
      <section className="px-5 pb-20 md:px-8">
        <div className="mx-auto grid max-w-6xl gap-5 rounded-[2rem] bg-green-deep p-7 text-white shadow-[0_25px_80px_rgba(24,58,34,0.18)] md:grid-cols-[1.2fr_0.8fr] md:items-center md:p-10">
          <div>
            ...
            <h2 className="mt-4 font-display text-3xl leading-tight md:text-4xl">Vous connaissez un terrain adapté ?</h2>
            <p className="mt-4 max-w-2xl text-base leading-8 text-white/80">Si vous connaissez un terrain agricole à acheter en Gironde, ou un propriétaire vendeur, votre aide peut faire avancer La Belle Poule. Les mises en relation sérieuses sont les bienvenues.</p>
          </div>
